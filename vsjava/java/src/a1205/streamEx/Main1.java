...
public class Main1 {
    public static void main(String[] args) {
        ...
        // 1.문제 2011년에 일어나 모든 트랜젝션을 찾아 오름차순으로 정렬하시오
        ...
        // 5. 케임브리지에 거주하는 거래자의 모든 트랜잭션값을 출력
        ...
        System.out.println(result);  // 최대값 객체 전체가 toString에 의해 나옴
        }
        ...
        System.out.println(result.get().getValue());  // Value값만 나옴
        }
}
