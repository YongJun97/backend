...
public class Reservation {
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            System.out.println("1.예약 가능한 숙소보기");
            System.out.println("2.숙소 예약하기");
            System.out.println("3.예약한 숙소보기");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    String accommodationName = sc.nextLine(); // 서울 A
                    if(manager.bookedAccommodations(accommodationName)){
                        System.out.println("숙소가 성공적 으로 예약 되었습니다.");
                    }else{
                        System.out.println("숙소가 예약 가능하지 않거나 존재하지 않습니다.");
                    }
                    break;
                    // 예약 할 수 있는 숙소가 있으면 예약한 후 true , 그렇지 않으면 false
                case 3:
                    System.out.println("예약한 숙소 보기");
                    manager.disBookedAccomodation();

                    break;
                case 4:
                    System.out.print("추가 할 숙소 이름을 입력 \n 숙소이름>>");
                    String newName = sc.nextLine();
                    System.out.print("숙소위치>>");
                    String newLocation = sc.nextLine();
                    System.out.print("일당숙박가격>>");
                    Double newPrice = sc.nextDouble();
                    sc.nextLine(); // 개행문자 초기화(오류 방지용)
                    System.out.println(newName + "추가하려는 숙소 이름");
                    if(newName.equals("")){ // 숙소 이름이 입력이 안되어 있으면 재입력 받기
                        System.out.print("추가 할 숙소 이름을 입력 \n 숙소이름>>");
                        newName = sc.nextLine();
                    }
                ...
                case 5:
                    ...
                    System.out.println("삭제하려는 호텔 이름을 입력:");
                    String dname = sc.nextLine();
                    if(dname.equals("")){
                        System.out.print("삭제하려는 호텔 이름을 재입력 \n 이름>>");
                        dname = sc.nextLine();
                    }
                ...
                case 6:
                    ...
                    System.out.println("수정 하려는 호텔 이름을 입력:");
                    String uname = sc.nextLine();
                    System.out.println(uname);
                    if(uname.equals("")){
                        System.out.println("추가 하려는 숙소의 이름을 입력하세요. \n name>>");
                        newName = sc.nextLine();
                    }
                ...
                case 7:
                    ...
                    if(sname.equals("")){
                        System.out.println("조회 하려는 숙소의 이름을 입력하세요. \n name>>");
                        newName = sc.nextLine();
                    }
